          ...
          <div className="relative flex flex-col items-center justify-center min-h-screen bg-white-100 dark:bg-gray-900">
            ...
            <div className="flex justify-center mt-10">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* 個人資料卡片 */}
                <Link href="./profile-settings/personal-info" passHref>
                  {" "}
                  {/* 使用 Link 組件包裹卡片 */}
                ...
                {/* 我的訂單卡片 */}
                <Link href="./my-orders/order-tracking" passHref>
                  {" "}
                  {/* 使用 Link 組件包裹卡片 */}
                  <div className="card bg-blue-500 text-white shadow-xl w-full md:w-80 lg:w-96 cursor-pointer">
                    <div className="card-body flex flex-row items-center">
            ...
            <div className="flex justify-center mt-10">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* 我的付款卡片 */}
                <Link href="./profile-settings/payment-methods" passHref>
                  {" "}
                  {/* 使用 Link 組件包裹卡片 */}
                  <div className="card bg-blue-500 text-white shadow-xl w-full md:w-80 lg:w-96 cursor-pointer">
                    <div className="card-body flex flex-row items-center">
                ...
                {/* 我的地址卡片 */}
                <Link href="./profile-settings/shipping-address" passHref>
                  {" "}
                  {/* 使用 Link 組件包裹卡片 */}
                  <div className="card bg-blue-500 text-white shadow-xl w-full md:w-80 lg:w-96 cursor-pointer">
                    <div className="card-body flex flex-row items-center">
            ...
            <div className="flex justify-center mt-10">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* 我的收藏卡片 */}
                <Link href="./my-favorites/wishlist" passHref>
                  {" "}
                  {/* 使用 Link 組件包裹卡片 */}
                  <div className="card bg-blue-500 text-white shadow-xl w-full md:w-80 lg:w-96 cursor-pointer">
                    <div className="card-body flex flex-row items-center">
                ...
                {/* 常見問題卡片 */}
                <Link href="./profile-settings/FAQ" passHref>
                  {" "}
                  {/* 使用 Link 組件包裹卡片 */}
                  <div className="card bg-blue-500 text-white shadow-xl w-full md:w-80 lg:w-96 cursor-pointer">
                    <div className="card-body flex flex-row items-center">
