...
const GameCard = ({ game }) => {
    ...
    return (
<section 
    className="bg-[#003E52] dark:bg-gray-900 transition-colors duration-200 hover:bg-[#EFB880] relative w-4/5 mx-auto rounded-lg mb-6 cursor-pointer group"
    ...
    <div className="container mx-auto py-10 border-b-2 border-[#EFB880] rounded-lg">
        <div className="lg:flex lg:items-center">
            ...
            <div className="relative lg:w-1/2 lg:mx-6 rounded-lg">
                <p className="text-sm text-[#EFB880] uppercase group-hover:text-[#003E52]">
                ...
                <a href="#" className="inline-block mt-2 text-[#EFB880] underline group-hover:text-[#003E52]">詳看內文</a>
                ...
                <div className="absolute bottom-4 right-4 flex flex-col space-y-2">
                    <button className="px-4 py-2 w-32 border border-[#EFB880] rounded text-[#EFB880] transition group-hover:bg-[#003E52] group-hover:text-white transform hover:scale-110">
                        聯絡房主
                    </button>
                    <button 
                        className="px-4 py-2 w-32 border border-[#EFB880] rounded text-[#EFB880] transition group-hover:bg-[#003E52] group-hover:text-white transform hover:scale-110"
                        onClick={(e) => {
